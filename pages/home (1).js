...
export default async function render(container){
  container.innerHTML = `<div class="card"><div style="display:flex;align-items:center;justify-content:space-between">
    <div>
  ...
  <div id="home-body" class="mt-4"></div></div>`;
  ...
  if(!user){
    ...
    container.querySelector('#home-action').innerHTML = `<button class="btn" onclick="location.href='/'">Login</button>`;
    return;
  }
  ...
  body.innerHTML = `
    ...
    <div style="display:flex;gap:12px;flex-wrap:wrap">
      ...
      <div class="card"><div>Active Bots</div><div class="text-xl font-bold mt-2">—</div></div>
    </div>
